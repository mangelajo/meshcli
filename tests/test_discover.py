...
class TestNearbyNodeDiscoverer:
    ...
    def test_init_with_params(self):
        ...
        discoverer = NearbyNodeDiscoverer(interface_type='tcp', device_path='test.local')
...
def test_discover_command_execution(mock_discoverer_class):
    ...
    assert result.exit_code == 0
    mock_discoverer_class.assert_called_once_with(interface_type='serial', device_path=None)
